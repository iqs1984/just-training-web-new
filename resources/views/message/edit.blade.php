        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Messages</div>
                    </div>
            ...
            <!-- start widget -->
            <form class="row smooth-submit" id="update-message" method="POST" action="update/message">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control hidden" name="id" value="{{$message->id}}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" rows="5">{{$message->description}}</textarea>
                            </div>

                            <div class="form-group">
                                <label for="title">Link ( Youtube,Vimeo, facebook )</label>
                                <input type="text" class="form-control" name="link" id="link"  value="{{$message->link}}">
                            </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <select class="form-control" name="group_ids[]" multiple style="height: 270px;">
                                    @foreach($groups as $group)
                                        <option {{$message->inGroup($group->id) ? 'selected' : null}} value="{{$group->id}}">{{$group->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-lg-12 mx-auto mt-3">
                                ...
                                <label class="embed-responsive embed-responsive-16by9">
                                    <img src="{{$message->image->exists()? $message->image->url:'img/default-image.png'}}" class="embed-responsive-item" id="header_image">
