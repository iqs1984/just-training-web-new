            ...
            <div class="row">
                ...
                <div class="col-lg-8 p-2">
                    <div class="card" style="min-height: 241px;">
                        <div class="card-body">
                            <div><h4 class="text-primary">{{$training->title}}</h4></div>
                ...
                @if($training->confirmed_players->count())
                        ...
                        <div class="card">
                            <div class="card-header bg-warning row m-0">
                                ...
                                <div class="col-4 text-right">
                                    <strong>Total : </strong> {{$training->confirmed_players->count()}}
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-striped table-hover training-player-table m-0">
                                    ...
                                    <tbody>
                                    @foreach($training->confirmed_players as $key=>$player)
                                        <tr>
                                            <td>{{$key+1}}</td>
                ...
                @if($training->do_not_confirmed_players->count())
                <div class="col-lg-12 p-2">
                    <div class="card">
                        <div class="card-header bg-danger row m-0">
                            ...
                            <div class="col-4 text-right">
                                <strong>Total : </strong> {{$training->do_not_confirmed_players->count()}}
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped table-hover training-player-table m-0">
                                ...
                                <tbody>
                                @foreach($training->do_not_confirmed_players as $key=>$player)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td class="player-image"><img src="{{$player->image->url}}"></td>
                                    <td>{{$player->name}}</td>
                ...
                @if($training->unconfirmed_players->count())
                    <div class="col-lg-12 p-2">
                        <div class="card">
                            <div class="card-header bg-success row m-0">
                                ...
                                <div class="col-4 text-right">
                                    <strong>Total : </strong> {{$training->unconfirmed_players->count()}}
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-striped table-hover training-player-table m-0">
                                    ...
                                    <tbody>
                                    @foreach($training->unconfirmed_players as $key=>$player)
                                        <tr>
                                            <td>{{$key+1}}</td>
                                            <td class="player-image"><img src="{{$player->image->url}}"></td>
                                            <td>{{$player->name}}</td>
